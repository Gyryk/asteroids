...
/**  Default constructor. */
Spaceship::Spaceship()
	: GameObject("Spaceship"), mThrust(0), mInvulnerableTimeLeft(0), mBrakeUpgradeTimeLeft(0)
{
}

/** Construct a spaceship with given position, velocity, acceleration, angle, and rotation. */
Spaceship::Spaceship(GLVector3f p, GLVector3f v, GLVector3f a, GLfloat h, GLfloat r)
	: GameObject("Spaceship", p, v, a, h, r), mThrust(0), mInvulnerableTimeLeft(0), mBrakeUpgradeTimeLeft(0)
{
}

/** Copy constructor. */
Spaceship::Spaceship(const Spaceship& s)
	: GameObject(s), mThrust(0), mInvulnerableTimeLeft(0), mBrakeUpgradeTimeLeft(0)
{
}
...
void Spaceship::Update(int t)
{
	...
	if (mBrakeUpgradeTimeLeft > 0)
	{
		mBrakeUpgradeTimeLeft -= t;
		if (mBrakeUpgradeTimeLeft < 0) mBrakeUpgradeTimeLeft = 0;
	}
...
void Spaceship::ApplyBrake(void)
{
	if (!HasBrakes()) return;
	mVelocity *= 0.7f;
}
...
void Spaceship::EnableBrakesFor(int ms)
{
	mBrakeUpgradeTimeLeft = ms;
}
